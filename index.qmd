...
carbon_plot <- ggplot(data = nutrient_clean_2)+
  ...
  labs(y = 'Dissolved Organic Carbon (µmol/kg)',
       x = 'Depth (meters)',
       title = 'Depth Profile of Dissolved Organic Carbon',
...
carbon_plot + nitrogen_plot +
  plot_annotation(
    caption = '\nDashed line represents average concentration.\n The main takeaway message behind these profiles is that the most activity occurs between 40 - 60 m below \nsea level. Dissolved Organic Carbon sharply declines whereas Dissolved Organic Nitrogen sharply increases.',
    theme = theme(
